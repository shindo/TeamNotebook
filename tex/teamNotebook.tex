...
\lstinputlisting{../src/tarjanDFS.cpp}
...
\subsection{kD-tree}
\lstinputlisting{../src/kdTree.cpp}


\newpage
\section{Geometry}
\subsection{Point 2D}
\lstinputlisting{../src/geom2D.cpp}
\subsection{Point 3D}
\lstinputlisting{../src/geom3D.cpp}
...
\section{Misc}
\subsection{Dates}
\lstinputlisting{../src/dates.cpp}
\subsection{Long Long Multiplication}
\lstinputlisting{../src/longMul.cpp}
\subsection{Gray Code}
\lstinputlisting{../src/gray.cpp}
